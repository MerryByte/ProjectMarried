...
grant update (upload_unlock_at, ceremony_time, ceremony_location, celebration_time, celebration_location, updated_at) on public.site_settings to authenticated;
